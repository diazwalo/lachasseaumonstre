...
public class Position {
	 ...
	 * @return Une position qui indique la diffÃ©rence.
	 */
	...
	/**
	 * Retourne le mouvement effectuÃ© pour se deplacer entre deux positions.
	 * @param currentPosition La position actuelle.
	 * @param toPosition la position finale.
	 * @return Le mouvement pour se deplacer de la position courante Ã  la position finale.
	 */
